...
bool ImGui::MinimizeButton(ImGuiID id, const ImVec2& pos)
{
    ...
    if (hovered)
        window->DrawList->AddRectFilled(bb.Min, bb.Max, bg_col);
    RenderNavCursor(bb, id, ImGuiNavRenderCursorFlags_Compact);
    window->DrawList->AddLine(bb.GetCenter() - ImVec2(g.FontSize * 0.25f, 0.0f), bb.GetCenter() + ImVec2(g.FontSize * 0.25f, 0.0f), GetColorU32(ImGuiCol_Text));
...
bool ImGui::MaximizeButton(ImGuiID id, const ImVec2& pos)
{
    ...
    if (hovered)
        window->DrawList->AddRectFilled(bb.Min, bb.Max, bg_col);
    RenderNavCursor(bb, id, ImGuiNavRenderCursorFlags_Compact);
    window->DrawList->AddRect(bb.GetTL() + ImVec2(g.FontSize * 0.25f, g.FontSize * 0.25f), bb.GetBR() - ImVec2(g.FontSize * 0.25f, g.FontSize * 0.25f), GetColorU32(ImGuiCol_Text));
    return pressed;
}
