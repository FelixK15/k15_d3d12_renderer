...
bool initTest(test_context_frame_parameter_t* pFrameParameter)
{
    ...
    pTestData->pTexture = createGpuTexture(pFrameParameter->pGraphicsFrame, createUint3(textureWidth, textureHeight, 1), pImageData, gpu_texture_format_t::R8G8B8A8, gpu_texture_format_type_t::normalized_unsigned_int, gpu_memory_usage_hint_t::gpuExclusiveAccess, gpu_texture_flag_t::use_as_unordered_access_view, 1u);
