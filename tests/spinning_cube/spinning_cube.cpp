...
void doFrame(test_context_frame_parameter_t* pFrameParameter)
{
    ...
    bindTexture(pRenderPass, pTestData->pTexture, 0u);
    bindTextureSampler(pRenderPass, pTestData->pSampler, 0u);
...
constexpr uint32_t textureData[] = {
    0xFFFFCCFF,
    0xFFFFCCFF,
    0xFFFFCCFF,
    0xFFFFCCFF,
...
bool initTest(test_context_frame_parameter_t* pFrameParameter)
{
    ...
    samplerParameter.mipmapFilter = texture_sampler_filter_type_t::point;
    samplerParameter.minifactionFilter = texture_sampler_filter_type_t::point;
    samplerParameter.magnificationFilter = texture_sampler_filter_type_t::point;
    ...
    pTestData->pTexture = createGpuTexture(pFrameParameter->pGraphicsFrame, createUint3(128, 128, 1), textureData, gpu_texture_format_t::R8G8B8A8, gpu_texture_format_type_t::unsigned_int, gpu_memory_usage_hint_t::gpuExclusiveAccess, gpu_texture_flag_t::use_as_unordered_access_view, 1u);
